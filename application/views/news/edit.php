...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            ...
            <h3 class="card-title float-right"><?= $tittle_2 ?> <?= $tittle ?></h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label class="picture" for="picture__input" tabIndex="0">
                                    <span class="picture__image">
                                        <img src="<?= base_url('upload/news/' . $data_news->news_image) ?>" alt="" id="picture__image">
                                    </span>
                                </label>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="news_title" placeholder="Masukkan Judul" value="<?= $data_news->news_title ?>">
                </div>
                <div class="col-md-12">
                    ...
                    <select name="" class="form-control" id="news_category">
                        ...
                        <?php foreach ($kategori_berita as $kb) : ?>
                            <?php if ($kb->id == $data_news->news_category) { ?>
                                <option value="<?= $kb->id ?>" selected> <?= $kb->name ?></option>
                            <?php } else { ?>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="content_news" id="content_news" cols="30" rows="10"><?= $data_news->news_content ?></textarea>
                </div>
                <div class="col-md-12">
                    <label for="">&nbsp;</label>
                    <input type="hidden" id="news_id" value="<?= $data_news->news_id ?>">
                    <button class="btn btn-primary btn-block" id="submit_news"> <i data-feather="save"></i> Save </button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#submit_news').on('click', function() {
            ...
            formData.append('news_image', $('#picture__input').prop('files')[0] == undefined ? 'kosong' : $('#picture__input').prop('files')[0]);
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == 200) {
                        ...
                        $('#submit_news').html('<i data-feather="save"></i> Save');
