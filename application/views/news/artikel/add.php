...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <a href="<?= base_url('news/artikel') ?>" class="btn btn-primary float-left"><i data-feather="arrow-left"></i> Back</a></a>
            <h3 class="card-title float-right">Tambah Artikel</h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == 200) {
                        ...
                        setTimeout(function() {
                            window.location.href = '<?= base_url('news/artikel') ?>';
                        },1000);
                    }
                },
                error: function(err) {
