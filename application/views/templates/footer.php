<!-- Footer Section -->
<footer class="bg-dark text-white pt-20 pb-6">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div data-aos="fade-up" data-aos-delay="150">
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="#home" class="text-gray-400 hover:text-primary transition-colors">Beranda</a>
                    </li>
                    <li>
                        <a href="#services" class="text-gray-400 hover:text-primary transition-colors">Layanan</a>
                    </li>
                    <li>
                        <a href="#gallery" class="text-gray-400 hover:text-primary transition-colors">Galeri</a>
                    </li>
                    <li>
                        <a href="#testimonials" class="text-gray-400 hover:text-primary transition-colors">Testimoni</a>
                    </li>
                    <li>
            ...
            <div data-aos="fade-up" data-aos-delay="350">
                ...
                <p class="text-gray-400 mb-6">
                    Dapatkan info promo dan tips perawatan mobil terbaru langsung ke email Anda
                </p>
                <form class="flex">
                    <input type="email" placeholder="Email Anda" class="px-4 py-3 rounded-l-lg w-full focus:outline-none">
                    <button type="submit" class="bg-primary text-dark px-4 py-3 rounded-r-lg font-bold hover:bg-white transition-colors">
                        Daftar
                    </button>
                </form>
            </div>
