            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="description_syarat" cols="30" rows="10"> <?= $data ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#save').click(function() {
            ...
            const description_syarat = tinymce.get('description_syarat').getContent();

            formData.append('description_syarat', description_syarat);

            $.ajax({
                url: '<?= site_url($site_url . '/update_syarat_ketentuan') ?>',
                type: 'POST',
                processData: false,
                contentType: false,
                data: formData,
