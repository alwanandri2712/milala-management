            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="description_sejarah" cols="30" rows="10"> <?= $data_sejarah ?> </textarea>
                    </div>
                    <div class="col-md-12">
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#save').click(function() {
            ...
            const description_sejarah = tinymce.get('description_sejarah').getContent();

            formData.append('description_sejarah', description_sejarah);

            $.ajax({
                url: '<?= site_url($site_url . '/update_sejarah') ?>',
                type: 'POST',
                processData: false,
                contentType: false,
                data: formData,
