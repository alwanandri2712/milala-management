...
<section id="keunggulan" class="py-24 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-12" data-aos="fade-up">
            <!-- Keunggulan 1 -->
            <div class="bg-white p-8 rounded-2xl shadow-xl border-2 border-primary flex flex-col items-center text-center">
                <div class="w-20 h-20 bg-primary rounded-2xl mb-6 flex items-center justify-center">
                    <svg class="w-12 h-12 text-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c1.104 0 2-.896 2-2s-.896-2-2-2-2 .896-2 2 .896 2 2 2zm0 2c-2.21 0-4 1.79-4 4v4h8v-4c0-2.21-1.79-4-4-4z" />
                    </svg>
                </div>
                <h3 class="text-2xl font-bold mb-4">Teknisi Berpengalaman</h3>
                <p class="text-gray-600">Tim kami terdiri dari teknisi ahli yang sudah berpengalaman lebih dari 20 tahun di bidang power steering & kaki-kaki.</p>
            </div>
            <!-- Keunggulan 2 -->
            <div class="bg-white p-8 rounded-2xl shadow-xl border-2 border-primary flex flex-col items-center text-center">
                <div class="w-20 h-20 bg-primary rounded-2xl mb-6 flex items-center justify-center">
                ...
                <h3 class="text-2xl font-bold mb-4">Suku Cadang Original</h3>
                <p class="text-gray-600">Kami hanya menggunakan suku cadang original dan bergaransi untuk memastikan ketahanan dan keamanan kendaraan Anda.</p>
            </div>
            <!-- Keunggulan 3 -->
            <div class="bg-white p-8 rounded-2xl shadow-xl border-2 border-primary flex flex-col items-center text-center">
                <div class="w-20 h-20 bg-primary rounded-2xl mb-6 flex items-center justify-center">
                ...
                <h3 class="text-2xl font-bold mb-4">Garansi Pengerjaan</h3>
                <p class="text-gray-600">Setiap pengerjaan dilengkapi garansi sehingga Anda tidak perlu khawatir dengan hasil servis kami.</p>
            </div>
            <!-- Keunggulan 4 -->
            <div class="bg-white p-8 rounded-2xl shadow-xl border-2 border-primary flex flex-col items-center text-center">
                <div class="w-20 h-20 bg-primary rounded-2xl mb-6 flex items-center justify-center">
                    <svg class="w-12 h-12 text-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16h6m2 4a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v11a2 2 0 002 2h10z" />
                    </svg>
                </div>
                <h3 class="text-2xl font-bold mb-4">Layanan Konsultasi</h3>
                <p class="text-gray-600">Konsultasikan masalah mobil Anda secara gratis dengan teknisi kami sebelum melakukan perbaikan.</p>
            </div>
            <!-- Keunggulan 5 -->
            <div class="bg-white p-8 rounded-2xl shadow-xl border-2 border-primary flex flex-col items-center text-center">
                <div class="w-20 h-20 bg-primary rounded-2xl mb-6 flex items-center justify-center">
                    <svg class="w-12 h-12 text-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L8 21h8l-1.75-4M12 3v4m0 0a4 4 0 00-4 4v1a4 4 0 004 4 4 4 0 004-4V11a4 4 0 00-4-4z" />
                    </svg>
                </div>
                <h3 class="text-2xl font-bold mb-4">Peralatan Modern</h3>
                <p class="text-gray-600">Bengkel kami dilengkapi peralatan modern dan teknologi terbaru untuk hasil pengerjaan yang lebih presisi.</p>
            </div>
            <!-- Keunggulan 6 -->
            <div class="bg-white p-8 rounded-2xl shadow-xl border-2 border-primary flex flex-col items-center text-center">
                <div class="w-20 h-20 bg-primary rounded-2xl mb-6 flex items-center justify-center">
                    <svg class="w-12 h-12 text-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m4 0h1v4h1m-5 0h1v-4h1m-4 0h1v4h1" />
                    </svg>
                </div>
                <h3 class="text-2xl font-bold mb-4">Ribuan Pelanggan Puas</h3>
                <p class="text-gray-600">Lebih dari 10.000 pelanggan telah mempercayakan servis power steering & kaki-kaki mobilnya kepada kami.</p>
            </div>
        </div>
    </div>
</section>
