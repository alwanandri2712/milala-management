...
class Reservasi_mobil_model extends CI_Model
{
    ...
    var $column_order  = array('no_polisi','type_mobil','tahun', 'no_rangka','cabang','created_by', 'created_date');
    var $column_search = array('no_polisi','type_mobil','tahun', 'no_rangka','cabang','created_by', 'created_date');
