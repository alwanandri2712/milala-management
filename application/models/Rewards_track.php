...
class Rewards_track extends CI_Model
{

    var $vtable        = 'reward_track';
    var $column_order  = array('image', 'title', 'fullname','status', 'created_date');
    var $column_search = array('image', 'title', 'fullname','status','created_date');
