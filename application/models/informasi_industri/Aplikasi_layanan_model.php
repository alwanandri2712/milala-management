...
class Aplikasi_layanan_model extends CI_Model
{

    var $vtable        = 'aplikasi_layanan_industri';
    var $column_order  = array('images', 'title','description', 'created_by', 'created_date');
    var $column_search = array('images', 'title','description', 'created_by', 'created_date');
