...
class KontakKami_model extends CI_Model
{
    ...
    var $vtable        = 'contact_us';
    var $column_order  = array('title','description', 'created_by', 'created_date');
    var $column_search = array('title','description', 'created_by', 'created_date');
