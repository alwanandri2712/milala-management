...
class RiwayatLogin_model extends CI_Model
{

    var $vtable        = 'history_login';
    var $column_order  = array('last_login','browser','ip_address' , 'user_agents');
    var $column_search = array('last_login','browser','ip_address' , 'user_agents');
