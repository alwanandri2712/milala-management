...
class SettingsPopup_model extends CI_Model
{

    var $vtable        = 'settings_popup';
    var $column_order  = array('images', 'title', 'status', 'created_by');
    var $column_search = array('images', 'title', 'status', 'created_by');
