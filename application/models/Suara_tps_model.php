<?php
/*
 * Author : Alwan Putra Andriansyah 
 */

defined('BASEPATH') or exit('No direct script access allowed');

class Suara_tps_model extends CI_Model
{

    var $table         = 'suara_tps';
    var $vtable        = 'suara_tps';
    var $column_order  = array('total_suara','kecamatan', 'kelurahan_desa', 'dusun', 'rt', 'rw', 'tps', 'created_by', 'created_date');
    var $column_search = array('total_suara','kecamatan', 'kelurahan_desa', 'dusun', 'rt', 'rw', 'tps', 'created_by', 'created_date');
    ...
    private function _get_datatables_query($kota = null, $kecamatan = null, $kelurahan = null)
    {
    ...
    function get_datatables($kota = null, $kecamatan = null, $kelurahan = null)
    {
        $this->_get_datatables_query($kota, $kecamatan, $kelurahan);
        if (@$_POST['length'] != -1)
    ...
    function count_filtered($kota = null, $kecamatan = null, $kelurahan = null)
    {
        $this->_get_datatables_query($kota, $kecamatan, $kelurahan);
        $query = $this->db->get();
    ...
    public function count_all($kota = null, $kecamatan = null, $kelurahan = null)
    {
        $this->db->from($this->vtable);
